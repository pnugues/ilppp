...
config = {'Optimizer': OPTIMIZER, 'Embedding dim': EMBEDDING_DIM,
          'Context size': W_SIZE, 'Batch size': BATCH_SIZE,
          'Epochs': EPOCHS, 'Corpus': CORPUS, 'Mini corpus': MINI_CORPUS}
...
X = dict_vect.fit_transform(X_dict_train)
X_dev = dict_vect.transform(X_dict_dev)
